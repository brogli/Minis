...
namespace Minis
{
    ...
    public sealed class MidiDevice : InputDevice
    {
        ...
        public int OneBeatClockCounter { get; private set; } = 0;
        public int TwoBeatsClockCounter { get; private set; } = 0;
        public int FourBeatsClockCounter { get; private set; } = 0;
        ...
        private const int _beatClockTicksForFourBeats = _beatClockTicksForOneBeat * 4;
